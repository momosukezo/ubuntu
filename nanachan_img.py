...
detected_faces = face_detector(img, 2)
landmarks = []
...
print(len(landmarks[0]))    # Nose tip
#print(landmarks[0][8]),     # Chin
#print(landmarks[0][36]),     # Left eye left corner
...
print('PnP' + str(PnP))
print('distcoeffs' + str(dist_coeffs))
...
print('imagepoint0' + str(image_points[0]))
print('imagepoint1' + str(image_points[1]))
print('imagepoint' + str(image_points))
